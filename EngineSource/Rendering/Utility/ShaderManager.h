...
struct ShaderElement
{
	...
	ShaderElement(Shader* Shader, int References = 1)
	{
		this->Shader = Shader;
...
void DereferenceShader(Shader* Shader); //Derefences Shader, if Count of References for that shader <= 0, the shader will be deleted.